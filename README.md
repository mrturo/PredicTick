...
- `adx_14`: Average Directional Index over 14 periods; measures trend strength.
- `atr`: Average True Range; daily price volatility.
- `atr_14`: Smoothed ATR using 14-period EMA.
...
- `momentum_3h`: Price change compared to 3 hours ago.
...
- `return_1h`: Return over the past hour.
- `volatility`: Estimated session volatility.
- `volatility_3h`: Volatility over last 3 hours.
