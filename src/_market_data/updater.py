...
from _market_data.summarizer import Summarizer
from _market_data.symbol_processor import SymbolProcessor
from _market_data.validator import Validator
...
class Updater:
    ...
    @staticmethod
    def update_data(in_max_retries: int = 0, filepath: Optional[str] = None):
