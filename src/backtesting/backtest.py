...
from market_data._old.gateway import Gateway
...
indicator_params = EnrichedData.get_indicator_parameters()
...
def backtest_same_symbol_all_days(symbol: str, market_data=None):
    ...
    market_data_dict = Handler.load_old() if market_data is None else market_data
...
if __name__ == "__main__":
    local_old = Handler.load_old()
    # backtest_same_symbol_all_days("TSLA", local_old)
    # backtest_best_symbol_per_day(xtb_symbols, local_old)
    # backtest_best_symbol_per_day(mercado_pago_symbols, local_old)
    backtest_same_symbol_all_days("TSLA", local_old)
