"""
Module that defines the Candle class for analyzing individual Japanese candlesticks,.

and the MultiCandlePattern class for detecting multi-candle reversal patterns.
