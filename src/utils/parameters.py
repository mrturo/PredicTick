...
class ParameterLoader:
    ...
    _ENRICHED_MARKETDATA_FILEPATH = "data/market_enriched_data.json"
    _EVALUATION_REPORT_BASEPATH = "data/evaluation/"
    _EVENT_DATES_FILEPATH = "config/event_dates.json"
    ...
    _RAW_MARKETDATA_FILEPATH = "data/market_raw_data.json"
    ...
    _TEST_ENRICHED_MARKETDATA_FILEPATH = "data/market_enriched_data.json"
    ...
    def _initialize_parameters(self) -> Dict[str, Any]:
        ...
        constant_params = {
            ...
            "bollinger_window": 20,
            "candle_metrics": {
                "doji_body_threshold": 0.1,  # the body represents less than 10% of the total range
                "hammer_body_threshold": 0.3,  # the body is less than 30% of the total range
                "hammer_shadow_ratio": 2.0,  # the lower shadow must be at least 2x the body size
                "lower_shadow_max_ratio": 0.3,  # small lower shadow: less than 30% of the body
                "shooting_star_body_threshold": 0.3,  # small body: less than 30% of the total range
                "shooting_star_shadow_ratio": 2.0,  # upper shadow must be at least 2x the body size
                "upper_shadow_max_ratio": 0.3,  # upper shadow is less than 30% of the body
                "doji_max_upper_shadow": 0.1,  # Max upper shadow/body ratio for Dragonfly Doji
                "doji_max_lower_shadow": 0.1,  # Max lower shadow/body ratio for Gravestone Doji
            },
