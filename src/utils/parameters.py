...
class ParameterLoader:
    ...
    def __init__(self, last_updated: Optional[pd.Timestamp] = None):
        ...
        tmp_stock_exchange: Optional[StockExchange] = StockExchange.from_parameter(
            exchange_default, exchanges
        ).to_utc()
        if tmp_stock_exchange is None:
            raise ValueError("Stock exchange not found")
        self._stock_exchange: StockExchange = tmp_stock_exchange
    ...
    def exchange(self) -> StockExchange:
