...
class SessionsHours:
    ...
    * timezone: IANA timezone string (e.g. ``"America/New_York"``) used to interpret
       all :class:`utils.hours.Hours` objects.
    """
    ...
    def pre_market(self) -> Optional[Hours]:
        """Return the pre-market :class:`utils.hours.Hours`, or ``None``."""
    ...
    def regular(self) -> Hours:
        """Return the regular trading-session :class:`utils.hours.Hours`."""
    ...
    def post_market(self) -> Optional[Hours]:
        """Return the post-market :class:`utils.hours.Hours`, or ``None``."""
