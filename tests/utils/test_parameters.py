...
# pylint: disable=redefined-outer-name, unused-argument
@patch("src.utils.parameters.SymbolRepository")
def test_parameter_loader_exchange_method(mock_repo_class):
    ...
    if exchange.code != "NYSE":
        raise AssertionError("Expected exchange code to be 'NYSE'")
...
@patch("src.utils.parameters.SymbolRepository")
@patch("src.utils.parameters.StockExchange.from_parameter")
