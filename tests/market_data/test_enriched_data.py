...
from market_data.transform.enriched_data import EnrichedData, TechnicalIndicators
...
def test_filter_prices_from_global_min_returns_none_if_no_min_datetimes():
    """Verify that _filter_prices_from_global_min returns None if no symbol has historical_prices."""
    symbols = {
        "AAPL": {"symbol": "AAPL", "name": "Apple"},
        "GOOG": {"symbol": "GOOG", "name": "Google"},
    }
    result = EnrichedData._filter_prices_from_global_min(symbols)
