...
@patch("market_data.raw_data.RawData.get_last_update", return_value=None)
@patch("market_data.raw_data.RawData.load")
...
@patch("market_data.updater.Updater.update_data")
@patch("market_data.raw_data.RawData.get_last_update")
@patch("market_data.raw_data.RawData.load")
