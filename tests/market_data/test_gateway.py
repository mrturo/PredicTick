...
def test_set_and_get_symbol(sample_symbol_data):
    ...
    if retrieved is None:
        raise AssertionError("Symbol 'AAPL' was not found.")
...
def test_save_market_data_via_interface_indirect(monkeypatch, sample_symbol_data):
    ...
    if result is None or "last_updated" not in result:
...
def test_get_symbol_found(sample_symbol_data):
