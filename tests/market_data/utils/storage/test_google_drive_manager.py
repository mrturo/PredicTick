...
def test_download_file_success(fixture_mock_auth_service):
    ...
    with patch(
        "market_data.utils.storage.google_drive_manager.io.FileIO",
        return_value=MagicMock(),
    ) as _, patch(
        "market_data.utils.storage.google_drive_manager.MediaIoBaseDownload"
    ) as mock_downloader:
...
def test_validate_filename_path_object_raises_exception():
    ...
    with patch(
        "market_data.utils.storage.google_drive_manager.Path",
