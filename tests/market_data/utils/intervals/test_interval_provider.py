...
from market_data.utils.intervals.interval_provider import IntervalProvider
from market_data.utils.intervals.interval_validator import IntervalValidator


@patch.object(IntervalValidator, "is_valid", return_value=True)
@patch(
    "market_data.utils.intervals.interval_provider.IntervalProvider._INTERVAL",
    new_callable=dict,
)
