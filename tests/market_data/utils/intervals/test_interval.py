...
@patch("market_data.utils.intervals.interval_provider.IntervalProvider.resolve")
...
@patch("market_data.utils.intervals.interval_provider.IntervalProvider.resolve")
@patch("market_data.utils.intervals.interval_converter.IntervalConverter.to_minutes")
