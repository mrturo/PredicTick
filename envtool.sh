...
function clean_cache() {
    ...
    rm -rf .pytest_cache .mypy_cache .cache dist build *.egg-info htmlcov .coverage nonexistent.json logs tests/data data/market_enriched_data.json
...
function code_check() {
    ...
    pylint --persistent=no --ignore-paths='src/_old/.*|tests/_old/.*' "${paths[@]}"
